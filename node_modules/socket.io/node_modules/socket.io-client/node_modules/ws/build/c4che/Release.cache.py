...
CPPPATH_NODE = '/cust/nodejs/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
...
LIBDIR = '/Users/darren/.node_libraries'
LIBPATH_NODE = '/cust/nodejs/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-O3', '-arch', 'x86_64']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/darren/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/cust/nodejs'
